...
categories:
    - Articles
---
If you've stumbled across this post, **welcome!** Whether you’ve come across my posts before or just landed here by accident (thanks, search engine magic), I’m glad you’re here.
...
This **NEW** blog is all about Microsoft Cloud, Data and AI and the wider ecosystem of technologies that have shaped my career, from the NT4 days (yes, really) through Hyper-V, RDP, domain services, and now deep into cloud. I’m currently working as an Azure Practice Lead at Cloud Direct, a UK-based Microsoft partner, and I’ve had the privilege of helping businesses modernise, scale, and thrive using Microsofts ever-evolving cloud capabilities.

#### What to expect here:

* Bi-weekly posts (that’s the plan!) diving into technical Cloud, Data and AI topics, real-world scenarios, and lessons learned
* Reflections from my journey
* Occasional throwbacks as I migrate content from my old blog, some of it might even still hold up!

Whether you're just starting out with Microsoft's Cloud technologies or you're neck-deep in designing enterprise-grade solutions, I hope this blog becomes a space where we can learn, share, and maybe even debate a little.
